...
public class Hunspell {
     ...
     * directory specified.
     *
     * @param libDir Optional absolute directory where the native lib can be
     * found.
     */
     ...
     * @param libDir Optional absolute directory where the native lib can be
     * found.
     * @throws UnsupportedOperationException if the OS or architecture is simply
     * not supported.
     */
  ...
  /**
     ...
     *
     * @param baseFileName the base name of the dictionary, passing /dict/da_DK
     * means that the files /dict/da_DK.dic and /dict/da_DK.aff get loaded
     */
